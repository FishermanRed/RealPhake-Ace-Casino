	...
	case WM_COMMAND:
	  switch(wp){
		case 1: //User Info page
		  if (alreadyOpen == 0){
			hUserInfo = CreateWindowW(L"userInfoClass", L"User Info", WS_VISIBLE | WS_BORDER | !WS_SIZEBOX, 710, 75, 500, 600, hMainWnd, NULL, NULL, NULL); //Make User Info window
